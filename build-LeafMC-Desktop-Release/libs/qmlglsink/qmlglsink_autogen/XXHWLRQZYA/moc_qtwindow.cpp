...
#include <memory>
#include "../../../../../LeafMC/libs/qmlglsink/gst-plugins-good/ext/qt/qtwindow.h"
...
void QtGLWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QtGLWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QtGLWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickWindow::staticMetaObject>(),
    qt_meta_stringdata_QtGLWindow.data,
    qt_meta_data_QtGLWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
