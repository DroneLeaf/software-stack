...
#include <memory>
#include "../../../../../LeafMC/libs/qmlglsink/gst-plugins-good/ext/qt/gstqsgtexture.h"
...
QT_INIT_METAOBJECT const QMetaObject GstQSGTexture::staticMetaObject = { {
    QMetaObject::SuperData::link<QSGTexture::staticMetaObject>(),
    qt_meta_stringdata_GstQSGTexture.data,
    qt_meta_data_GstQSGTexture,
    qt_static_metacall,
    nullptr,
    nullptr
} };
