...
#include <memory>
#include "../../../../../LeafMC/src/QmlControls/CustomAction.h"
...
struct qt_meta_stringdata_CustomAction_t {
    QByteArrayData data[6];
    char stringdata0[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CustomAction_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CustomAction_t qt_meta_stringdata_CustomAction = {
    {
QT_MOC_LITERAL(0, 0, 12), // "CustomAction"
QT_MOC_LITERAL(1, 13, 6), // "sendTo"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8), // "Vehicle*"
QT_MOC_LITERAL(4, 30, 7), // "vehicle"
QT_MOC_LITERAL(5, 38, 5) // "label"

    },
    "CustomAction\0sendTo\0\0Vehicle*\0vehicle\0"
    "label"
};
...
void CustomAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendTo((*reinterpret_cast< Vehicle*(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject CustomAction::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CustomAction.data,
    qt_meta_data_CustomAction,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CustomAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CustomAction.stringdata0))
